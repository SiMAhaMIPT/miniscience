...
public:
    ...
    void move(double tau, int step) {
        double m = x;
        double x_0 = x;
        double y_0 = y;
        double z_0 = z;
        //x = cos(step*M_PI/50)*x + sin(step*M_PI/50)*y; 
        //y = -sin(step*M_PI/50)*m + cos(step*M_PI/50)*y;
        x = cos(M_PI/50)*x + sin(M_PI/50)*y; 
        y = -sin(M_PI/50)*m + cos(M_PI/50)*y;
        /*
        x += vx;
        y += vy;
        z += vz;
        */
        vx = 0.001*y;
        vy = -0.001*x;
        if ((pow(x, 2) + pow(y, 2)) < 114 && (pow(x, 2) + pow(y, 2) > 100) && (z > 1) && (z < 5)){smth += 0.01/22;}
        else {smth = sqrt(pow(x-20, -2)) + sqrt(pow(y-20, -2)) + sqrt(pow(z - 20, -2)) + sqrt(pow(x-20, -2) + pow(y-20, -2)) + sqrt(pow(y-20, -2) + pow(z - 20, -2)) + sqrt(pow(x-20, -2) + pow(z - 20, -2)) + sqrt(pow(x-20, -2) + pow(y-20, -2) + pow(z - 20, -2)) + sqrt(pow(20+x, -2)) + sqrt(pow(20+y, -2)) + sqrt(pow(20+z, -2)) + sqrt(pow(20+x, -2) + pow(20+y, -2)) + sqrt(pow(20+y, -2) + pow(20+z, -2)) + sqrt(pow(20+x, -2) + pow(20+z, -2)) + sqrt(pow(20+x, -2) + pow(20+y, -2) + pow(20+z, -2));}
        /*
        x = x_0;
        y = y_0;
        z = z_0;
...
public:
    ...
    CalcMesh(const std::vector<double>& nodesCoords, const std::vector<std::size_t>& tetrsPoints) {
        ...
        for(unsigned int i = 0; i < nodesCoords.size() / 3; i++) {
            ...
            double smth = sqrt(pow(pointX-20, -2)) + sqrt(pow(pointY-20, -2)) + sqrt(pow(pointZ - 20, -2)) + sqrt(pow(pointX-20, -2) + pow(pointY-20, -2)) + sqrt(pow(pointY-20, -2) + pow(pointZ - 20, -2)) + sqrt(pow(pointX-20, -2) + pow(pointZ - 20, -2)) + sqrt(pow(pointX-20, -2) + pow(pointY-20, -2) + pow(pointZ - 20, -2)) + sqrt(pow(20+pointX, -2)) + sqrt(pow(20+pointY, -2)) + sqrt(pow(20+pointZ, -2)) + sqrt(pow(20+pointX, -2) + pow(20+pointY, -2)) + sqrt(pow(20+pointY, -2) + pow(20+pointZ, -2)) + sqrt(pow(20+pointX, -2) + pow(20+pointZ, -2)) + sqrt(pow(20+pointX, -2) + pow(20+pointY, -2) + pow(20+pointZ, -2));
            double vx = 0.001*pointY;
            double vy = -0.001*pointX;
            double vz = 0;
    ...
    void snapshot(unsigned int snap_number) {
        ...
        string fileName = "one-" + std::to_string(snap_number) + ".vtu";
...
int main()
{
    ...
    for(unsigned int step = 1; step < 240; step++) {
